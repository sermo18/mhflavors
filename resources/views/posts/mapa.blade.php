...
<div class="container-fluid ">
    ...
    <div class="row text-center mapaback">
        ...
        <div id="map-container " class=" map-container mb-4 col-6" >
            ...
            <iframe class="mb-4 shadow p-3" src="https://www.google.com/maps/d/embed?mid=1LmlfBYmV4ljXxjqELdmLOBscH02e-GxV&hl=es" width="50%" height="50%" frameborder="0" style="border:0"></iframe>
        </div>
