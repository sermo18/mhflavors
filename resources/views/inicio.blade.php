...
<div class="container">
    ...
    <div class="row mt-4 ">
        ...
        <div class="col-12 my-4 justify-content-center align-content-center">
            <div class="row">
                ...
                <div class="card col-6 col-md-3 noBorde " style="border: none; border-radius: 0;">
                    <div class="card-body text-center noBorde ">
                        ...
                        <h3 class="card-text  noBorde my-4 ">
                            +50 Usuarios
                        </h3>
                ...
                <div class="card col-6 col-md-3 noBorde" style="border: none;border-radius: 0;">
                    <div class="card-body text-center noBorde">
                        <h3 class="card-title  noBorde ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#343a40" class="bi bi-flower1" viewBox="0 0 16 16">
            ...
            <div class="row">
                <div class="card col-12 col-md-6 noBorde " style="border: none;border-radius: 0;">
                    <div class="card-body text-center noBorde">
                        <h3 class="card-title noBorde ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="66" height="60" fill="#343a40" class="bi bi-wind" viewBox="0 0 16 16">
                ...
                <div class="card col-12 col-md-6 noBorde" style="border: none;border-radius: 0;">
                    <div class="card-body text-center  noBorde">
                        <h3 class="card-title text-center noBorde "><svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#343a40" class="bi bi-shop" viewBox="0 0 16 16">
        ...
        <div class="card col-12 col-md-6 noBorde ">
            ...
            <div class="card-body noBorde">
                <h5 class="card-title noBorde">Cual es nuestra misión?</h5>
                <p class="card-text noBorde">
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
                    industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type
                    and scrambled it to make a type specimen book. It has survived not only five centuries, but also the
        ...
        <div class="card col-12 col-md-6 noBorde">
            ...
            <div class="card-body noBorde">
                <h5 class="card-title noBorde">¿Cual es nuestra visión?</h5>
                <p class="card-text noBorde">
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
                    industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type
                    and scrambled it to make a type specimen book. It has survived not only five centuries, but also the
