        ...
        <div class="col-12 my-4 justify-content-center align-content-center">
            <div class="row">
                ...
                <div class="card col-6 col-md-3 noBorde " style="border: none; border-radius: 0;">
                    <div class="card-body text-center noBorde ">
                        <div class="card-title  noBorde ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" fill="#343a40"
                ...
                <div class="card col-6 col-md-3 noBorde " style="border: none;border-radius: 0;">
                    <div class="card-body text-center noBorde">
                        <h3 class="card-title noBorde ">
                            <svg xmlns="http://www.w3.org/2000/svg" width="66" height="60" fill="#343a40"
                ...
                <div class="card col-6 col-md-3 noBorde" style="border: none;border-radius: 0;">
                    <div class="card-body text-center  noBorde">
                        <h3 class="card-title text-center noBorde "><svg xmlns="http://www.w3.org/2000/svg" width="60"
                                height="60" fill="#343a40" class="bi bi-shop" viewBox="0 0 16 16">
                                <path
