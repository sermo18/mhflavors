...
@for ($i = 1; $i < 4; $i++)
         ...
         <div class="col-4 mb-3">
            ...
            @elseif($i == 3)
            <img class="card-img-top" src="https://www.ecig-vapo.com/images/product_277.jpg" alt="Card image cap">
                <div class="card-img-overlay">
