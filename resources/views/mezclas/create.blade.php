...
@for ($i = 1; $i < 4; $i++)
         ...
         <div class="col-4 mb-3">
            ...
            @if($i == 1)
                <img class="card-img-top"  style="filter:brightness(50%);" src="https://cachimbasbaratas.pro/wp-content/uploads/2018/12/tabaco-para-cachimba.jpg" alt="Card image cap">
            ...
            @elseif($i == 3)
            <img class="card-img-top" src="https://www.ecig-vapo.com/images/product_277.jpg" style="filter:brightness(50%);" alt="Card image cap">
                <div class="card-img-overlay">
