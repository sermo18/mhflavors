...
<div class="table-responsive">
    ...
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td class="text-center">
                ...
                <a class="m-1 "><button type="button" class="btn btn-dark px-3"><svg xmlns="http://www.w3.org/2000/svg"
                            width="16" height="16" fill="white" class="bi bi-heart-fill" viewBox="0 0 16 16">
                            <path fill-rule="evenodd"
                                d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z" />
                        </svg></button></a>
                <a class="m-1 "><button type="button" class="btn btn-dark px-3" data-toggle="modal"
                ...
                <a href="{{ route('mezclas.valorar', $mezcla) }}" class="m-1 "><button type="button"
  ...
  <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
                ...
                @else
                <a href="{{ route('mezclas.añadir', $mezcla) }}" class="m-1 "><button type="button"
