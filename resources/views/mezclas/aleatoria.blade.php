...
<div class="container">
                            ...
                            <div class="col-md-12">
                                ...
                                <!-- Depend of a aleatory number the page shows a aleatory mixing that you will smoke today -->
                                    ...
                                    <h6 class="card-subtitle mb-2 text-light">
                                        {{$mezclas[$numeroAleatorio]->porcentaje1}}%</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-0">
                            <div class="col-md-12">
                                <div class="card-body" >
                                    ...
                                    @endforeach
                                    <h6 class="card-subtitle mb-2 text-light">
                                        {{$mezclas[$numeroAleatorio]->porcentaje2}}%</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-12 ">
                                <div class="card-body">
                                    ...
                                    @endforeach
                                    <h6 class="card-subtitle mb-2 text-light">
                                        {{$mezclas[$numeroAleatorio]->porcentaje3}}%</h6>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="my-1">
        <a href="{{ route('mezclas.aleatoria',random_int(0, count($mezclas)-1)) }}"><input type="button"
                value="Generar Mezcla" class="btn btn-dark btn-block"></input></a>
    </div>
</div>
